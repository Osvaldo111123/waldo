...
# >>==<< >>==<< >>==<< >>==<< >>==<< >>==<< >>==<<
# >>==<< >>==<< >>==<< >>==<< >>==<< >>==<< >>==<<
source('C:/Users/Alumno/Desktop/Nueva carpeta/MiRegresion.R')
X <- MiRegresion (X1,Y1)
#----------------------------------------------------
...
# >>==<< >>==<< >>==<< >>==<< >>==<< >>==<< >>==<<
source('C:/Users/Alumno/Desktop/Nueva carpeta/MiCoefCorr.R')
CoefCorr <- MiCoefCorr(X2,Y2); print(CoefCorr)
